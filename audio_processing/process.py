...
@app.command()
def insert_audio(audio: str, ad: str, start_time: int):
    main_audio = AudioSegment.from_file(BASE_PATH + audio)
    insert_ad = AudioSegment.from_file(BASE_PATH + ad)
...
@app.command()
def replace_audio(audio: str, ad: str, start_time: int, end_time: int):
    main_audio = AudioSegment.from_file(BASE_PATH + audio)
    ad = AudioSegment.from_file(BASE_PATH + ad)
    ...
    new_audio = first_part + ad + second_part
